...
- bsllmner-mk2 の出力 (`select_*.json` + `bs_entries_*.jsonl`) を `data/{chip-atlas-hg38,chip-atlas-mm10,rnaseq-human,rnaseq-mouse}/` 配下に配置済み (構成は [data/README.md](data/README.md) 参照)
...
### 0. 事前 cache (`build-srx-links` の前に必須)
